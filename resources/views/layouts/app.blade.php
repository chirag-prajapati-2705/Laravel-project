    ...
    <div class="header-top">
        <div class="container">
            ...
            <div class="col-sm-4 logo">
                <a href="index.html"><img src="{{ URL::asset('front/images/logo.png')}}" alt=""></a>
            </div>
        ...
        <div class="slider">
            <div class="callbacks_container">
                <ul class="rslides" id="slider">
                    <li>
                        <img src="{{ URL::asset('front/images/1.jpg')}}" alt="">
                    </li>
                    <li>
                        <img src="{{ URL::asset('front/images/2.jpg')}}" alt="">
                    </li>
                    <li>
                        <img src="{{ URL::asset('front/images/1.jpg')}}" alt="">
                    </li>
        ...
        <div class="content-top">
            ...
            <div class="content-top1">
                <div class="col-md-3 col-md2">
                    <div class="col-md1 simpleCart_shelfItem">
                        <a href="single.html">
                            <img class="img-responsive" src="{{ URL::asset('front/images/pi.png')}}" alt="" />
                        </a>
                ...
                <div class="col-md-3 col-md2">
                    <div class="col-md1 simpleCart_shelfItem">
                        <a href="single.html">
                            <img class="img-responsive" src="{{ URL::asset('front/images/pi2.png')}}" alt="" />
                        </a>
                ...
                <div class="col-md-3 col-md2">
                    <div class="col-md1 simpleCart_shelfItem">
                        <a href="single.html">
                            <img class="img-responsive" src="{{ URL::asset('front/images/pi4.png')}}" alt="" />
                        </a>
                ...
                <div class="col-md-3 col-md2">
                    <div class="col-md1 simpleCart_shelfItem">
                        <a href="single.html">
                            <img class="img-responsive" src="{{ URL::asset('front/images/pi1.png')}}" alt="" />
                        </a>
                        <h3><a href="single.html">Tops</a></h3>
                        <div class="price">
                            <h5 class="item_price">$300</h5>
            ...
            <div class="content-top1">
                <div class="col-md-3 col-md2">
                    <div class="col-md1 simpleCart_shelfItem">
                        <a href="single.html">
                            <img class="img-responsive" src="{{ URL::asset('front/images/pi3.png')}}" alt="" />
                        </a>
                        <h3><a href="single.html">Shirt</a></h3>
                        <div class="price">
                            <h5 class="item_price">$300</h5>
                ...
                <div class="col-md-3 col-md2">
                    <div class="col-md1 simpleCart_shelfItem">
                        <a href="single.html">
                            <img class="img-responsive" src="{{ URL::asset('front/images/pi5.png')}}" alt="" />
                        </a>
                        <h3><a href="single.html">T-Shirt</a></h3>
                        <div class="price">
                            <h5 class="item_price">$300</h5>
                ...
                <div class="col-md-3 col-md2">
                    <div class="col-md1 simpleCart_shelfItem">
                        <a href="single.html">
                            <img class="img-responsive" src="{{ URL::asset('front/images/pi6.png')}}" alt="" />
                        </a>
                ...
                <div class="col-md-3 col-md2">
                    <div class="col-md1 simpleCart_shelfItem">
                        <a href="single.html">
                            <img class="img-responsive" src="{{ URL::asset('front/images/pi7.png')}}" alt="" />
                        </a>
                        <h3><a href="single.html">Tops</a></h3>
                        <div class="price">
                            <h5 class="item_price">$300</h5>
...
<div class="footer">
    ...
    <div class="footer-bottom">
        <div class="container">
            ...
            <div class="clearfix"> </div>
            <p class="footer-class"> © 2016  All Rights Reserved | Design by <a href="" target="_blank">chirag prajapati</a> </p>
        </div>
    </div>
</div>
